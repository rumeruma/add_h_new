        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <h2>About Us</h2>
                    <hr>
                    <p class="about-lt">Address Help 360 is a Bangladeshi Business Directory Website. Address Help 360 aims to build a Digital Bangladesh</p>
                    <a href="http://www.addresshelp360.com/about-us" class="btn-primary-link more-detail"><i class="fa fa-hand-o-right"></i> Read
                        More</a>
                    <h2>Follow Us</h2>
                    <hr>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <p class="text-xs-center">© BENGALI ICT LTD. 2018</p>
                </div>
