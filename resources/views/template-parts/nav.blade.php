                        ...
                        <div class="row">
                            <div class="col-sm-5 hidden-xs">
                                <div class="top-bar-socials">
                                    ...
                                    <a target="_blank" href="{{ $sl['url'] }}" class="social-icon-sm si-dark si-gray-round si-colored-{{ $sl['type'] }}">
                                        <i class="fa fa-{{ $sl['type'] }}"area-hidden="true"></i>
                                        <i class="fa fa-{{ $sl['type'] }}"area-hidden="true"></i>
                                    </a>
                                    @endforeach
                                </div>
                            ...
                            <div class="col-sm-7 text-right">
                                <ul class="list-inline top-dark-right">
                                    ...
                                    @if (Auth::guest())
                                    <li><a href="#" class="" data-toggle="modal" data-target="#login"><i class="fa fa-lock"></i>Login</a></li>
                                    <li><a href="#" class="" data-toggle="modal" data-target="#register"><i class="fa fa-lock"></i>Sign Up</a></li>
                                    @else
