            ...
            <div class="col-sm-6 hidden-xs">
                <div class="top-bar-socials">
                    @foreach($links as $link)
                        <a target="_blank" area-hidden="true" href="{{ $link['url'] }}"
                                ...
                                <a class="cbp-caption cbp-lightbox"
                                   href="{{ $slider }}">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="{{ $slider }}" alt="image"  style="height:235px; width:335px;" id="gallery">
                                    </div>
                                </a>
                            </div>
                        </div>
...
<footer id="footer">
    <div class="container">
        <div class="row">
            <span>© BENGALI ICT LTD. 2018</span>
        </div>
    </div>
